...
const createFormGroup = (dataItem: { UserID: any; UserName: any; UserEmail: any; UserPhone: any; }) =>
  new FormGroup({
    ...
    UserPhone: new FormControl(dataItem.UserPhone, [Validators.required, Validators.pattern("^((\\+91-?)|0)?[0-9]{10}$")]),
  });
